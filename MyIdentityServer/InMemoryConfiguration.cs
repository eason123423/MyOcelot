        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    RedirectUris = new List<string>(){ "http://www.baidu.com","https://localhost:44379/signin-oidc"},
                    PostLogoutRedirectUris = new List<string>(){ "http://www.baidu.com","https://localhost:44379/signin-oidc"},
                    //罪魁祸首
                ...
                new Client
                {
                    ...
                    RedirectUris = new List<string>(){ "http://www.baidu.com"},
                    PostLogoutRedirectUris = new List<string>(){ "http://www.baidu.com"},
                    //是否显示授权提示界面
                    RequireConsent = true,
                    AllowedScopes = {
                        IdentityServerConstants.StandardScopes.OpenId,
